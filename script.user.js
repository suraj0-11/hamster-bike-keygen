...
const EVENTS_DELAY = 1000; // Set total delay to 1 second for faster progress indication
...
function initProgress(keyText) {
  ...
  async function progressDelay(unexpected) {
    ...
    const delay = EVENTS_DELAY / totalProgress; // Adjust delay interval for 1-second total
    const delayInterval = delay;
